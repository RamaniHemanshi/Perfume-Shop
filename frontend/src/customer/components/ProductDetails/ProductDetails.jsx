...
const product = {
  ...
  sizes: [
    ...
    { name: "125ml", inStock: true },
  ],
  description:
    'ntroducing our captivating fragrance, an exquisite blend of floral notes delicately intertwined with hints of citrus and musk. Embrace the enchanting allure of jasmine and rose petals, gracefully balanced by the freshness of bergamot and mandarin. With every spritz, experience a symphony of elegance and sophistication that lingers delicately on your skin, leaving a trail of timeless allure wherever you go. Unveil the essence of luxury with our signature scent, a masterpiece crafted to adorn the senses and evoke an unforgettable sensation of opulence and refinement.',
  highlights: [
    "Our perfume is long lasting",
    "Perfume's fragrance is unforgettable",
    "Experience our luxury performance",
    "Embark on a scented journey of luxury and elegance with our meticulously curated collection of unique fragrances.",
  ],
};
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[45rem]">
              <img
                ...
                className="h-[38rem] w-[33rem] object-cover object-center"
              />
            </div>
          ...
          {/* Product info */}
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 s:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold text-gray-900">
              {products.product?.brand}
              </h1>
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-5">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="font-semibold">₹{((products?.product?.price || 0) - (products?.product?.discountedPrice || 0))}</p>
              ...
              <form className="mt-10" onSubmit={handleAddToCart}>
                ...
                <Button onClick={handleAddToCart} variant="contained" sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd" ,marginTop: 1 }}>
                  Add To Cart
                </Button>
              </form>
            </div>
        ...
        {/* <section className="pt-10">
          ...
          <h1 className="py-5 text-xl font-bold ml-4">Similer Products</h1>

          <div className="grid grid-cols-5 gap-5 mr-4">
            {mens_perfume.map((item)=><HomeSectionCard product={item}/>)}
          </div>
        </section> */}
      </div>
    </div>
